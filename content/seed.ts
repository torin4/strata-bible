    ...
    passages: [
      {
        ...
        prayer: { mode: 'pray', text: 'How long, O Lord. I will not put on a brave face to come to you. Stay with me in the dark, and bring me, in your own time, to the turn.' },
      },
    ],
  },
    ...
    passages: [
      {
        ...
        prayer: { mode: 'meditate', text: 'Picture, one by one, the people with the least power over you, the hired hand, the deaf, the foreigner, the neighbor, and ask how you have been treating each.' },
      },
    ],
  },
    ...
    passages: [
      {
        ...
        prayer: { mode: 'pray', text: 'I keep doing the thing I do not want, and I am tired of it. Thanks be to God, who does not leave me in the wretched cry. Rescue in me what I cannot rescue myself.' },
      },
    ],
  },
    ...
    passages: [
      {
        ...
        prayer: { mode: 'mantra', text: 'Shape me, do not insure me.' },
      },
    ],
  },
    ...
    passages: [
      {
        ...
        prayer: { mode: 'meditate', text: 'Name the power that claims to be the only one that matters, and look at it from above, smaller than it says, already on a short leash.' },
      },
    ],
  },

  {
    ...
    passages: [
      ...
      },
      {
        ...
        prayer: { mode: 'meditate', text: 'Hold your honest complaint and your trust in the same hand, and let the size of the world be, for now, enough.' },
      },
    ],
  },
];
