...
export const READING_THEMES: Record<string, ReadingThemes> = {
  ...
  "ex-22": {
    themes: ["the-outsider", "injustice", "complicity"],
    speaksTo:
      "For an ethic built out of what you have been rather than what you believe, and for who gets to rest because of how you arrange your week.",
  },
  "ex-24": {
    themes: ["calling", "fear", "deliverance"],
    speaksTo:
      "For the agreements you could not later claim you had not entered, and for eating in the presence of something you were told not to touch.",
  },
  "ex-25": {
    themes: ["god-feels-absent", "waiting", "overlooked"],
    speaksTo:
      "For wanting presence rather than a visit, and for the unseen tending that keeps a light going through the night.",
  },
  "ex-28": {
    themes: ["calling", "overlooked", "limits"],
    speaksTo:
      "For carrying other people's names into the room with you, and for the skill in your hands being a gift rather than an achievement.",
  },
  "ex-32": {
    themes: ["waiting", "guilt", "god-feels-absent"],
    speaksTo:
  ...
  "ex-20": {
    ...
    speaksTo:
      "For wanting to know what is actually being asked of you, and for the part of you that resents being told at all.",
  },
  "gen-15": {
  ...
  "mark-3": {
    themes: ["loneliness", "calling", "overlooked"],
    speaksTo:
      "For when the people who have known you longest treat what you are doing now as a symptom.",
  },
  "mark-4": {
    themes: ["doubt", "waiting", "deferred-hope", "god-feels-absent"],
    speaksTo:
      "For work that mostly does not take, and for the delay you have started reading as indifference.",
  },
  "mark-5": {
    themes: ["shame", "the-outsider", "powerlessness", "fear"],
    speaksTo:
  ...
  "mark-14a": {
    themes: ["fear", "guilt", "loneliness"],
    speaksTo:
      "For the prayer that is not answered, and for getting up and going anyway.",
  },
  "mark-14b": {
    themes: ["shame", "guilt", "fear"],
    speaksTo:
      "For the thing you let pass because saying otherwise would have made the room difficult.",
  },
  "mark-15": {
    themes: [
      "god-feels-absent",
    ...
    speaksTo:
      "For dying with the question still open, and for the one person who could see it being the one who did it.",
  },
  "mark-16": {
    themes: ["fear", "grief", "doubt", "calling"],
    speaksTo:
